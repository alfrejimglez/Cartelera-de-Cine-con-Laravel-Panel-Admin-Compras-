          ...
          <tr>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Proceder y eligir butaca</h5>
                      ...
                      <div class="modal-body">
                        <p>Selecciona tus butacas</p>
                          Para cambiar tu lugar asignado da click en el butaca deseada.</p>
                      </div>
            ...
            <td>
              <div class="alert alert-success" role="alert">
                <div class="padre">
             <h4  class="hijo" class="alert-heading">Son <?php echo number_format($suma , 2); ?> &euro;
            </h4>
            ...
            <button type="submit" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary" name="B1"><span class="glyphicon glyphicon-shopping-cart"></span> Elegir butaca</button>
