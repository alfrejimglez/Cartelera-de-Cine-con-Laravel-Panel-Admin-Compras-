...
@php
   ...
   {
   $ticket = rand (13400,36500);
   
   DB::table('pedidos')->insert(
                    array('ticket' => $ticket , 'total' => $final, 'pelicula' => $nombre, 'usuario' => $user )
                );
...
@endphp  
          ...
          <tr>
            ...
            <td><div class="alert alert-warning alert-dismissible fade show" role="alert">
              <strong> {{ $pelicula['nombre'] }}  </strong> </td>
              @php
            ...
            <td>
             ...
             <h4 class="alert-heading">Pago efectuado correctamente <?php echo number_format($final , 2); ?> &euro; , <strong> Ticket generado ,</strong>         
              <br> <?php
              echo  $ticket  ;
              echo "<br>";
              echo "<h3> Pedido por </h3>";
              echo  $user  ;
              echo "<br>";
              echo "<br>";


              ?><br><strong>Entregalo al encargado para acceder a la sala</strong>
            </h4>
            ...
            <button type="submit" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary" name="B1"><span class="glyphicon glyphicon-shopping-cart"></span> Realizar pedido</button>
            <a href="butaca" > <button type="submit"  class="btn btn-danger" name="B1"></span> Volver</button>
            </a>
