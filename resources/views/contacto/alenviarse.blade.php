...
@role('administrador')
  ...
  <div class="card-header"></div>
         ...
         <div class="card-body">
            <h2 class="font-weight-bold" class="text-justify">Gracias por su colaboración. Su duda y/o sugerencia ha sido enviada correctamente a nuestro administrador.        </h2>
